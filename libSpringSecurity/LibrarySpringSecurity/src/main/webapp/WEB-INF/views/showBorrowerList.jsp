...
<div class="container">
	...
	<table class="table table-hover">
				...
				<c:forEach var="borrower" items="${borrowerList}">
					...
					<tr id="borrower_row_${borrower.cardNo}">
						<td>${borrower.cardNo}</td>
						<td id="borrower_name_${borrower.cardNo}">${borrower.name}</td>
						<td id="borrower_add_${borrower.cardNo}">${borrower.address}</td>
						<td id="borrower_phone_${borrower.cardNo}">${borrower.phone}</td>
						<td><button type="button" class="btn btn-info"
								onClick="javascript:showBorrowerModal(${borrower.cardNo}, '${borrower.name}', '${borrower.address}', '${borrower.phone}');"
							>Update</button></td>
						<td><button type="button" class="btn btn-warning"
								onClick="javascript:deleteBorrower(${borrower.cardNo});"
							>Delete</button></td>
					</tr>
				</c:forEach>
			</table>
